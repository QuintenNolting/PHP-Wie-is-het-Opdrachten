 ...
 *
 * 1.   De Url laat bij $_GET het kenmerk en antwoord zien, wat niet zo is bij $_POST.
 * 2.   $_POST wordt naar de body gestuurd, en $_GET wordt naar de url gestuurd omdat het een string is.
 **********************************************************/
$featureLabels = [
        "man"     => "Is het een man?",
